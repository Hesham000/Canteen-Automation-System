...
import 'package:orders/screen/user_form.dart';
  ...
  signUp() async {
    try {
      ...
      if (authCredential.uid.isNotEmpty) {
        Fluttertoast.showToast(msg: "Compelete the form");
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Create an account",
                          style: TextStyle(
                              fontSize: 22.sp, color: Color.fromARGB(245, 175, 25, 17)),
                        ),
                        // Text(
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              width: 41.w,
                              decoration: BoxDecoration(
                                  color: Color.fromARGB(245, 175, 25, 17),
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              primary: Color.fromARGB(245, 175, 25, 17),
                              elevation: 3,
                            ),
                          ),
                        ),
